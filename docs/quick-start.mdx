...
Lamby can be used with <DocLink id="anatomy" name="existing" /> Rails v5 application or higher. The quickest way to learn how Rails works on Lambda is to deploy a new application to your AWS account using our [cookiecutter project](https://github.com/rails-lambda/lamby-cookiecutter) template.
